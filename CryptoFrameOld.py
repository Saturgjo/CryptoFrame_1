...
#         key_data = f.read()  # Read the key data
#         print("Private key data read:", key_data[:50])  # Debug line to verify data is read correctly
#         private_key = RSA.import_key(key_data, passphrase=passphrase)  # Use key_data here, not f.read()
...
#     message_length_per_frame = len(message) // (total_frames // 20)
#     last_index = 0
